GO Flight flybarless and quadcopter controller is an open-source Arduino based project, which aims to provide an open-source, cheap (in components) and easy to use platform for R/C aviation.
